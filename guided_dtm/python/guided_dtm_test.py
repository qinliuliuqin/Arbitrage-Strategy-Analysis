import time
import pickle
from ldaseqmodel_guided2 import LdaSeqModel
...
t1 = time.time()
ldaseq = LdaSeqModel(corpus=corpus, time_slice=time_slice, id2word=v_dict, num_topics=num_topics, chunksize=1, em_min_iter=1, em_max_iter=10, seeds=seed_topic_list, pi=pi)
t2 = time.time()
